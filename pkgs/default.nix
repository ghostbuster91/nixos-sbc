...
in {
  inherit (bananaPiR3) armTrustedFirmwareMT7986 linuxPackages_latest_bananaPiR3 linuxPackages_6_18_bananaPiR3 ubootBananaPiR3 linuxPackages_6_18_bananaPiR3_minimal;
